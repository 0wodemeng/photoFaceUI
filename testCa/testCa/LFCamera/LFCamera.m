...
- (UIBezierPath *)getMaskPathWithRect: (CGRect)rect exceptRect: (CGRect)exceptRect
{
    ...
    CGFloat centerY = minY+height/2;
    CGFloat shapR=width/2;
    [path moveToPoint:CGPointMake(centerX + shapR, centerY)];
    [path addCurveToPoint:CGPointMake(centerX, centerY-shapR) controlPoint1:CGPointMake(centerX + shapR, centerY) controlPoint2:CGPointMake(centerX + shapR, centerY - shapR)];
    [path addCurveToPoint:CGPointMake(centerX - shapR, centerY) controlPoint1:CGPointMake(centerX, centerY - shapR) controlPoint2:CGPointMake(centerX - shapR, centerY - shapR)];
    [path addCurveToPoint:CGPointMake(centerX, centerY + shapR) controlPoint1:CGPointMake(centerX - shapR, centerY) controlPoint2:CGPointMake(centerX - shapR, centerY + width/2)];
    [path addCurveToPoint:CGPointMake(centerX + shapR, centerY) controlPoint1:CGPointMake(centerX, centerY + shapR) controlPoint2:CGPointMake(centerX + shapR, centerY + shapR)];
    
    [path addLineToPoint:CGPointMake(boundsWidth, centerY)];
    [path addLineToPoint:CGPointMake(boundsWidth, boundsHeight)];
    [path addLineToPoint:CGPointMake(0, boundsHeight)];
...
- (CAShapeLayer *)effectiveRectLayer {
    if (!_effectiveRectLayer) {
        ...
        _effectiveRectLayer.path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(scanRect.size.width/2+scanRect.origin.x, scanRect.size.height/2+scanRect.origin.y) radius:scanRect.size.width/2 startAngle:0 endAngle:360 clockwise:YES].CGPath;
...
- (CAShapeLayer *)maskLayer {
    if (!_maskLayer) {
        ...
        UIBezierPath *path=[self getMaskPathWithRect:self.bounds exceptRect:self.effectiveRect];
        path.lineWidth = 1;
        
        _maskLayer.path =path.CGPath;
        
        _maskLayer.fillColor = [UIColor yellowColor].CGColor;
        [_maskLayer setLineWidth:1.0f];
